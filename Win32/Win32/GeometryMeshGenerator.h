...
private:
	...
	void		mFunction_Build_A_Quad(FLOAT3 vOriginPoint, FLOAT3 vBasisVector1, FLOAT3 vBasisVector2, UINT StepCount1, UINT StepCount2, UINT iBaseIndex, std::vector<Vertex>& outVerticeList, std::vector<UINT>& outIndicesList);
